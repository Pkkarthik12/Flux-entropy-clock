...
## Features
- **Global Chaos Ingestion**: Pulls real-time volatility data from financial and environmental APIs.
- **Entropic Neural Engine**: An AI model that maps multi-dimensional chaos vectors into 3D kinetic coordinates.
- **Kinetic Actuator Control**: Directs hardware servos to manipulate physical matter (sand/marbles/light) into non-repeating entropic patterns.

## Project Structure
- `src/chaos_ingestor.py`: Connects to high-entropy data sources.
- `src/entropy_engine.py`: AI logic that calculates the "Chaos Vector".
- `src/kinetic_driver.py`: Translates vectors into hardware/servo commands.
- `src/main.py`: The core loop orchestrating the deconstruction of time.
